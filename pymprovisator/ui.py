...
class MainWindow:
    ...
    def __create_toolbar(self):
        ...
        self.image_chords = PhotoImage(file='pymprovisator/chords.gif')
        self.image_new = PhotoImage(file='pymprovisator/new.gif')
        self.image_open = PhotoImage(file='pymprovisator/open.gif')
        self.image_save = PhotoImage(file='pymprovisator/save.gif')
        self.image_play = PhotoImage(file='pymprovisator/play.gif')
        self.image_prefs = PhotoImage(file='pymprovisator/prefs.gif')
        self.image_clear = PhotoImage(file='pymprovisator/clear.gif')
...
def main(song_file=None):
    if song_file:
        print(f"Using song file: '{os.path.normpath(song_file)}'")
