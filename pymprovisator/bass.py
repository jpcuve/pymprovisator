...
def get_distance(chord1, chord2):
    ...
    if distance == 0:
        ...
        raise MyException("Error calculating distance between chords.")
...
def walking_pattern(ch, parts, meter):
    ...
    if parts < 1: raise MyException("Error in given parts. You must supply a value greater than 0.")
    if parts == 1:
